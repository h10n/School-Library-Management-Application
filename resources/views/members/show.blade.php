...
@section('content')
  ...
  <div class="box">
    <div class="box-header">
      ...
      <a class="btn bg-olive" href="{{ route('members.edit',$member->id) }}"><span class="ion-edit"> Edit Data</span></a>
      <a class="btn bg-purple" href="{{ route('admin.export.members.card',$member->id) }}"><span class="ion-printer"> Cetak Kartu</span></a>
      </div>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
  <div class="col-md-2">
              @if (isset($member) && $member->photo)
                <p>{!! Html::image(asset('img/members_photo/'.$member->photo),null,['class' => 'img-fluid member-photo']) !!}</p>
              @endif
  </div>
