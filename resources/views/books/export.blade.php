    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          {!! Form::open([
          'url' => route('admin.export.books.post'),
          'method' => 'POST',
          ...
          <div class="form-group {!! $errors->has('author_id') ? 'has-error' : '' !!}">
            ...
            <div class="col-md-4">
              {!! Form::select('author_id[]',['' => '']+App\Author::pluck('name','id')->all(),null,['class' =>
              'js-selectize','multiple','placeholder' => 'Pilih Penulis']) !!}
          ...
          <div class="form-group {!! $errors->has('type') ? 'has-error'  : '' !!}">
            ...
            <div class="col-md-4 checkbox">
              ...
              {!! $errors->first('type','<p class="help-block"><strong>:message</strong></p>') !!}
            </div>
          </div>
