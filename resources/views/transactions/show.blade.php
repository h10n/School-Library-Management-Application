  ...
  <div class="box">
    <div class="box-header">
      ...
      <div class="table-button-custom">
        <a class="btn bg-orange" href="{{ route('transactions.create') }}"><span class="ion-android-add"> Tambah
            Data</span></a>
    ...
    <div class="box-body">
      <div class="detail-buku">
        <div class="row">
          ...
          <div class="col-md-8">
            <a href="{{ route('members.show',$transaction->member_id) }}">{{ $transaction->member->nis }}</a>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
      ...
      <a class="btn bg-red" href="{{ route('transactions.index') }}"><span class="ion-android-arrow-back"> Kembali ke
          Daftar Transaksi</span></a>
    </div>
